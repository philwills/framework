...
object JE {
   ...
   */
  case class ElemById(id: String, then1: String*) extends JsExp {
    override def toJsCmd = "document.getElementById(" + id.encJs + ")" + (
      if (then1.isEmpty) "" else then1.mkString(".", ".", "")
    )
  }
...
"""
   ...
   */
  case class SetElemById(id: String, right: JsExp, then1: String*) extends JsCmd {
